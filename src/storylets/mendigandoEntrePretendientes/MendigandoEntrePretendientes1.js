...
const MendigandoEntrePretendientes1 = () => {
  ...
  return (
    <Storylet options={options}>
      ...
      Ignoráis dónde os encontráis exactamente, pero confiáis en la promesa de
      que la frontera queda en algún lugar, no demasiado lejos, hacia el norte.
      Así que esa es la dirección que seguís.
      <NewLine />
